...
<div class="slds-modal__container slds-p-around_none">
	...
	{if $ISADMIN}
		...
		<input type="hidden" name="_op" value="setconfigfsi">
		<div class="slds-form-element">
			<label class="slds-checkbox--toggle slds-grid">
			<span class="slds-form-element__label slds-m-bottom--none">{'_active'|@getTranslatedString:$MODULE}</span>
			<input type="checkbox" name="fsi_active" aria-describedby="toggle-desc" {if $isActive}checked{/if} />
		...
		<div class="slds-form-element slds-m-top--small">
			...
			<div class="slds-form-element__control">
				<input type="text" id="fsurl" name="fsurl" class="slds-input" value="{$fsurl}" />
			</div>
		</div>
		<div class="slds-form-element slds-m-top--small">
			<label class="slds-form-element__label" for="fstoken">{'fs_token'|@getTranslatedString:$MODULE}</label>
			<div class="slds-form-element__control">
				<input type="text" id="fstoken" name="fstoken" class="slds-input" value="{$fstoken}" />
			</div>
		</div>
		<div class="slds-m-top--large">
