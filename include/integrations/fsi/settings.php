 ...
 *************************************************************************************************
 *  Module    : FS Integration Settings
 *  Version   : 1.0
...
if ($isadmin && isset($_REQUEST['fsurl'])) {
	$isActive = ((empty($_REQUEST['fsi_active']) || $_REQUEST['fsi_active']!='on') ? '0' : '1');
...
$smarty->assign('isActive', $fsi->isActive());
$smarty->assign('fsurl', $fsisettings['fsurl']);
$smarty->assign('fstoken', $fsisettings['fstoken']);
...
$smarty->display('modules/Utilities/fsi.tpl');
?>
